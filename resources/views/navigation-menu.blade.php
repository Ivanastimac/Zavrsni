            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('instructions') }}">
                        <div>
                            <img src="{{ asset('mylogo.png') }}" style="height:60px"/>
                        </div>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('study') }}" :active="request()->routeIs('study')">
                        {{ __('Vježbanje') }}
                    </x-jet-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('instructions') }}" :active="request()->routeIs('instructions')">
                        {{ __('Upute') }}
                    </x-jet-nav-link>
                </div>
            </div>
